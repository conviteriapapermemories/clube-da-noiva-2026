    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-accent/20 shadow-soft">
          ...
          <span className="text-sm font-poppins font-medium text-foreground/80">Grupo VIP Exclusivo</span>
        </div>
        ...
        <p className="font-poppins text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
          O espaço exclusivo da <span className="font-semibold text-accent">Paper Memories Conviteria</span>, referência há mais de 12 anos em papelaria de luxo, criado para noivas que desejam viver o grande dia com elegância, propósito e identidade.
        </p>
